...
export default function ExitIntentPopup({ onOpenChat }: ExitIntentPopupProps) {
  ...
  const variantA = {
    title: '⚠️ Уходите? Не упустите +17% к конверсии!',
    subtitle: 'Автосалоны увеличили конверсию с 70% до 87% за месяц. Получите демо за 2 минуты.',
    buttonText: 'Показать демо бота',
  };

  const variantB = {
    title: '🤖 +80 лидов в месяц без увеличения рекламы',
    subtitle: 'Реальные кейсы: АвтоКипр и АвтоХайп получают +80-100 лидов ежемесячно. Закажите звонок!',
