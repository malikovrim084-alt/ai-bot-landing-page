  ...
  const cases = [
    {
      ...
      result: 'Конверсия из обращения в лид выросла с 70% до 87%, что дало прирост в 17 абсолютных процентных пунктов. Автосалон перестал терять ночные заявки, а база «тёплых» клиентов стала постоянным источником повторного вовлечения.',
      highlight: '+17% к конверсии',
      icon: 'Moon'
    },
    {
    ...
    {
      title: 'Автосалон «Автомобилия» г. Ярославль',
      task: 'Амбициозная цель: внедрить ИИ-оператора, который полностью возьмёт на себя обработку всех входящих чатов с классифайдов (Avito + Auto.ru), при этом участие отдела продаж сведётся к минимуму. До запуска бота чаты обрабатывались вручную, много заявок терялось или отвечали с большой задержкой.',
      solution: [
        'Полноценный ИИ-оператор в чатах Avito и Auto.ru: отвечает мгновенно 24/7, консультирует по моделям, комплектациям, ценам, наличию, условиям покупки, записывает на тест-драйв и собирает контактные данные.',
        'Минимальное вмешательство живых менеджеров: ИИ самостоятельно закрывает большинство диалогов до этапа передачи «тёплого» лида в отдел продаж.',
        'Запуск: с 9 февраля 2026 года.'
      ],
      result: 'Сравнение январь (без бота) → февраль (с ботом, период 9–25 февраля): Чаты: 339 → 334 (тот же уровень). Лиды: 111 → 170. Сделки: 4 → 9. Конверсия чат → лид: с 32.7% до 50.9% (+18.2 п.п.). Конверсия лид → сделка: с 3.6% до 5.3% (+1.7 п.п.). Количество сделок выросло более чем в 2 раза при том же объёме входящих сообщений.',
      highlight: '+18.2% к конверсии чат → лид',
      icon: 'Bot'
    },
    {
