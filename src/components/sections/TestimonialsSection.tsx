...
export default function TestimonialsSection() {
  const testimonials = [
    ...
    },
    {
      ...
      city: 'Екатеринбург',
      text: 'Подключили бота на WhatsApp и Авито. Контактов стало в 2,3 раза больше — клиенты пишут даже в 3 ночи! Бот собирает телефоны, менеджеры утром обзванивают горячие заявки. Скорость ответа упала с 40 минут до 10 секунд.',
      rating: 5,
    },
    {
      name: 'Игорь Кузнецов',
