        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-4">
            <div className="flex items-center justify-center gap-6 flex-wrap">
              <a href="tel:+79870266416" className="hover:text-primary transition-colors flex items-center gap-2">
                <Icon name="Phone" size={20} />
                +7 987 026 6416
              </a>
              <span className="text-slate-600">|</span>
              <p className="font-semibold">Рим Маликов</p>
              <span className="text-slate-600">|</span>
              <a href="https://khurma.pro" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                khurma.pro
              </a>
            </div>
            <div>
